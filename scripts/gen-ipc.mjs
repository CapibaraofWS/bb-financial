  ...
  series: {
    ...
    combinada: {
      ...
      fuentes: {
        ...
        '2000-01 a 2016-11': 'IPC-Argentina (matuteiglesias/IPC-Argentina), indice compuesto que enlaza los IPC de CABA, Cordoba y San Luis con el INDEC',
        'anterior a 2000-01': 'La oficial, reescalada para empalmar sin escalon: ese tramo no esta en discusion',
      },
      advertencia: 'Los indices provinciales no fueron intervenidos, pero son de alcance provincial y no nacional. Es una reconstruccion, no una medicion oficial del pais.',
    },
  },
